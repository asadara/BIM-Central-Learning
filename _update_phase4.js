...
const newFunction = [
  ...
  "                '/api/network-info'",
  "            ];",
  "            // Fallback to same host on port 5051 (when dashboard served on port 80/443)",
  ...
  "                    console.log('💡 Pastikan mengakses dashboard melalui server yang sama (port 5051 jika perlu)');",
